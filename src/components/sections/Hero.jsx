...
export function Hero() {
  ...
  return (
    <section 
      ref={containerRef} 
      className="relative h-[70vh] flex flex-col justify-center items-center overflow-hidden border-b border-hud px-4"
    >
      <div ref={textRef} className="flex flex-col items-center max-w-4xl mx-auto w-full">
        ...
        <div className="mt-12 flex flex-col md:flex-row justify-between items-start md:items-end w-full gap-8 border-t border-hud pt-8">
          ...
          <div className="flex-1 md:text-right">
            <p className="font-mono tracking-widest text-xs text-muted uppercase leading-relaxed">
