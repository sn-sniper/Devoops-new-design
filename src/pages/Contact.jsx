    ...
    <div className="min-h-[80vh] flex flex-col justify-center max-w-4xl mx-auto w-full px-4">
      ...
      >
        <div className="flex flex-col">
          <label className="font-mono text-xs text-white/50 mb-2 uppercase tracking-widest">
            [CLIENT.EMAIL]
          </label>
          <input
            type="email"
        ...
        <div className="md:col-span-2 flex justify-between items-end mt-8 border-t border-white/20 pt-8">
          ...
          <button className="px-8 py-4 font-mono text-sm tracking-widest hover:text-black transition-colors uppercase flex items-center gap-4 group clip-btn-brutalist-contact">
